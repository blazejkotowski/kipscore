  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tournament as @tournament" do
        ...
        post :create, {:tournament => { "user_id" => "invalid value" }}, valid_session
        assigns(:tournament).should be_a_new(Tournament)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tournament" do
        ...
        Tournament.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => tournament.to_param, :tournament => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tournament as @tournament" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tournament.any_instance.stub(:save).and_return(false)
        put :update, {:id => tournament.to_param, :tournament => { "user_id" => "invalid value" }}, valid_session
        assigns(:tournament).should eq(tournament)
      end
